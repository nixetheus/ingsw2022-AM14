...
/**
 * CloudTile class is the entity used to make the Cloud
 * The number of clouds is equals to the numbers of players
 */
public class CloudTile {
  ...
  /**
   * Constructor method:
   * @param id Unique identifier for each Cloud
   * students[] initialized to 0
   */
  ...
  /**
   * emptyCloud is used to empty the CloudTile,
   * it returns the array students and sets it to 0
   *
